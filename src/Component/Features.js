...
const Features = () => {
  ...
  <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900 lg:w-2/3 w-full">Pitchfork Kickstarter Taxidermy</h1>
  <p class="lg:w-2/3 w-full leading-relaxed text-gray-500 break-word">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table.</p>
</div>
