...
const Features = () => {
  return (
    <div className='max-w-[1280px] mx-auto px-4 mt-[150px] lg:mt-0'>
        <section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
  <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
  <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900 lg:w-2/3 w-full">Pitchfork Kickstarter Taxidermy</h1>
  <p className="lg:w-2/3 w-full leading-relaxed text-gray-500 break-word">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table.</p>
</div>
    ...
    <div className="flex flex-wrap -m-4 justify-center">
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-gray-200 p-6 rounded-lg flex flex-col items-center">
          ...
          <p className="leading-relaxed text-base text-center">Fingerstache flexitarian street art 8-bit waist co, subway tile poke farm.</p>
        </div>
      </div>
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-gray-200 p-6 rounded-lg flex flex-col items-center">
